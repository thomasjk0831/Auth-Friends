...
* Once your server is up and running, the URL you'll be able to hit from within your app is ``. You will however need an authentication header on all the calls except the login call.
